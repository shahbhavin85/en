...
public class SalesReportHandler extends Basehandler{
	...
	public String handlerRequest(HttpServletRequest request,
		...
		String pageType = "initSalesMasterRpt.jsp";
		// action to taken
	...
	public String getMasterReport(HttpServletRequest request) {
		String pageType = "salesMasterRpt.jsp";
		...
		if(reportBills.length == 0){
			...
			pageType = "initSalesMasterRpt.jsp";
		} else {
