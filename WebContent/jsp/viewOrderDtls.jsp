		...
		<fieldset>
			...
			<table width="100%">
				<tr>
					...
					&nbsp;<input type="button" value="Print" onclick="printOrder('<%=((OrderModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+"O"+((OrderModel)request.getAttribute(Constant.FORM_DATA)).getOrderId()%>',0)" />
					...
					&nbsp;<input type="button" value="Email" onclick="emailOrderBill('<%=((OrderModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+"O"+((OrderModel)request.getAttribute(Constant.FORM_DATA)).getOrderId()%>')" />
