...
<center><label style="font-family: Calibri; font-weight: bold; font-size: 15px;"><U>TAX INVOICE</U></label> <label style="font-family: Calibri; font-weight: bold; font-size: 15px;"><%=((model.getCustomer().getTin().equals("") && !model.getBranch().getNoTin().equals(""))) ? "<br/>"+model.getBranch().getNoTin() : (!model.getBranch().getNoTin().equals("")) ? "<br/>"+model.getBranch().getWithTin() : "" %></label></center>
...
<table width="100%" style="font-family: Calibri; font-size: 12px;">
	...
	<tr>
		<td align="left" colspan="3">
			<table width="100%">
				<tr>
					<td width="33%"><b>Mode of Transport:</b> <%=model.getTransport() %></td>
					<td width="32%"><b> L R No:</b> <%=model.getLrno() %></td>
					<td width="35%"><b> L R Dt:</b> <%=(model.getLrdt().equals("")) ? "" : Utils.convertToAppDate(model.getLrdt()) %></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td align="left" colspan="3">
			<table width="100%">
				<tr>
					<td width="33%"><b>No Of Cartoons:</b> <%=model.getCtns() %></td>
					<td width="32%"><b> Packed By:</b> <%=model.getPackedBy().getUserName() %></td>
					<td width="35%"><b> Despatched By:</b> <%=model.getDespatchedBy().getUserName() %></td>
				</tr>
			</table>
		</td>
	</tr>
...
<%
	...
	if(model.getPacking() > 0 || model.getForwarding() > 0 || model.getInstallation() > 0 || model.getLess() > 0 || model.getCess() > 0 || roundOff != 0){
		o++;
%>
	<tr>
...
%>
	<tr>
		<td align="right" style="border-bottom-color: white;" colspan="2">INSTALLATION</td>
		<td align="right" style="border-bottom-color: white; ">&nbsp;</td>
		...
		<td align="right" style="border-bottom-color: white; min-width:65px;"><%=Utils.get2Decimal(model.getInstallation())%></td>
	</tr>
<%  
	} 
...
%>
	<tr>
		<td align="right" style="border-bottom-color: white;" colspan="2">PACKING</td>
		<td align="right" style="border-bottom-color: white;">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</th>
		<td align="right" style="border-bottom-color: white; min-width:65px;">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:65px;"><%=Utils.get2Decimal(model.getPacking())%></td>
	</tr>
<%  
	} 
...
%>
	<tr>
		<td align="right" style="border-bottom-color: white;" colspan="2">FORWARDING</td>
		<td align="right" style="border-bottom-color: white; ">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</th>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:65px;">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:65px;"><%=Utils.get2Decimal(model.getForwarding())%></td>
	</tr>
<%  
	} 
	if(model.getCess() > 0){
		o++;
		total = Utils.get2DecimalDouble(total) + (ttotal*model.getCess())/100;
%>
	<tr>
		<td align="right" style="border-bottom-color: white;" colspan="2">CESS @ <%=model.getCess()%>% on <%=Utils.get2Decimal(ttotal)%></td>
		<td align="right" style="border-bottom-color: white; ">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</th>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:65px;">&nbsp;</td>
		<td align="left" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:50px;">&nbsp;</td>
		<td align="right" style="border-bottom-color: white; min-width:65px;"><%=Utils.get2Decimal((ttotal*model.getCess())/100)%></td>
	</tr>
<%  
	} 
	if(model.getLess() > 0){
...
<table class="dtls" width="100%" cellspacing ="0">
	<tr>
		<th style="border: 0px black;border-style: solid;vertical-align: top; width : 400px;  font-weight: bolder; padding-left:3px; margin-left:5px;font-size :13px;" align ="left">Payment: <%if(model.getPaymode() == 1) {%>CASH<%} else if(model.getPaymode() == 2) {%>CREDIT CARD<%} else {%>CREDIT<%}%><br/>Remarks: <%=model.getRemarks()%></th>
