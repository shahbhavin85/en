...
response.setHeader("Content-disposition","inline; filename=purchase_master_report_"+DateUtil.getCurrDt()+".xls"); %>
...
<body>
	<table width="100%" border="1" cellspacing="1" style="font-size: 11px; font-family: calibri;">
		<tr><td colspan="7" align="center">PURCHASE MASTER REPORT</td></tr>
		<tr>
		...
		<tr>
			...
			<td colspan="5"><%=(request.getAttribute("txtFromDate") != null && !((String)request.getAttribute("txtFromDate")).equals("")) ?  (String)request.getAttribute("txtFromDate") + " / " : "" %><%=(request.getAttribute("txtToDate") != null && !((String)request.getAttribute("txtToDate")).equals("")) ?  (String)request.getAttribute("txtToDate") : "" %></td>
		</tr>
		<%
		...
		%>
			<tr>
				<th style="width: 70px;">PURCHASE ID</th>
			...
			%>
				<tr>
					<td align="center" valign="top"><%=todayBills[i].getBranch().getBillPrefix()+"P"+Utils.padBillNo(todayBills[i].getPurchaseId()) %></td>
