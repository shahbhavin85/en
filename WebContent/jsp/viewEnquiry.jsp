...
<form method="post" name="frmViewEnquiry">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">View Enquiry</legend>
			<jsp:include page="messages.jsp"></jsp:include>
			<table cellpadding="3">
				<tr>
					<td align="right">Enquiry No.<span style="color: red">*</span> :</td>
					<td><input name="txtEnqNo" style="width: 80px;" maxlength="10"/>
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Get Enquiry Details" onclick="fnGetEnquiryDetails();"/></td>
				</tr>
			</table>
		</fieldset>
