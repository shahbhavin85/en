...
<form method="post" name="frmAddItemCat">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Mail Item Details</legend>
			...
			<table cellpadding="3">
				...
				<tr>
					<td align="right">Item<span style="color: red">*</span> :</td>
					<td>
						<select name="sItem" style="width: 500px;" tabindex="1" onchange="fnChangeBtnStatus(this)">
							<%	
...
function fnSendMail(){
	document.forms[0].HANDLERS.value = 'ITM_DTLS_HANDLER';
	document.forms[0].ACTIONS.value = 'MAIL_ITEM_DETAILS';
	fnFinalSubmit();
}
...
function fnChangeBtnStatus(itemCombo){
	if(itemCombo.value != '--' && document.forms[0].sCustomer.value != ""){
