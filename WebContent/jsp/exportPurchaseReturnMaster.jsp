...
response.setHeader("Content-disposition","inline; filename=purchase_return_master_"+DateUtil.getCurrDt()+".xls");
...
<%
try {
PurchaseReturnModel[] dtls = (PurchaseReturnModel[]) request.getAttribute("FORM_DATA");
...
<td><%=Utils.convertToAppDateWithSlash(model.getReturnDt()) %></td>
