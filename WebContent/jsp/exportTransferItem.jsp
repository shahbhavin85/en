...
response.setHeader("Content-disposition","inline; filename=transfer_items_"+DateUtil.getCurrDt()+".xls");
...
<%
try {
TransferItemModel[] dtls = (TransferItemModel[]) request.getAttribute("FORM_DATA");
