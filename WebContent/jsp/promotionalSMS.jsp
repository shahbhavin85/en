...
<form method="post" name="frmViewEnquiry">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Promotional SMS</legend>
			...
			<table cellpadding="3">
				...
				<tr>
					...
					<td><input type="text" name="txtMessage" value="" size="100" maxlength="160"/></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="button" value="Send SMS" onclick="fnSendMail();"/></td>
				</tr>
			</table>
		</fieldset>
...
function fnSendMail(){
	document.forms[0].HANDLERS.value = 'PROMOTIONAL_SMS_HANDLER';
