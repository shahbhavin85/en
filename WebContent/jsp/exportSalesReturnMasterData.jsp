...
response.setHeader("Content-disposition","inline; filename=sales_return_master_"+DateUtil.getCurrDt()+".xls");
...
<%
try {
CreditNoteModel[] dtls = (CreditNoteModel[]) request.getAttribute("FORM_DATA");
