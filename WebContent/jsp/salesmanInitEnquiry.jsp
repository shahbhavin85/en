...
<form method="post" name="frmViewEnquiry">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Enquiry Appointment</legend>
			<jsp:include page="messages.jsp"></jsp:include>
			<table cellpadding="3">
				<tr>
					<td align="right">Appointment Date<span style="color: red">*</span> :</td>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Go >>" onclick="fnGetPendingAppointment();"/></td>
				</tr>
			</table>
		</fieldset>
