		...
		<fieldset>
			...
			<table width="100%">
				<tr>
					...
					&nbsp;<input type="button" value="Print" onclick="printQuotation('<%=((QuotationModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+"Q"+((QuotationModel)request.getAttribute(Constant.FORM_DATA)).getQuotationId()%>')" />
