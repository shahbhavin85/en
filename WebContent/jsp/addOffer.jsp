...
<form method="post" name="frmAddOffer">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Add New Offer</legend>
			...
			<table cellpadding="3">
				...
				<tr>
					...
					value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((OfferModel)request.getAttribute(Constant.FORM_DATA)).getFromDate() : ""%>" tabindex="6"><img
                                    src='images/date.gif'
				...
				<tr>
					...
					value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((OfferModel)request.getAttribute(Constant.FORM_DATA)).getToDate() : ""%>" tabindex="6"><img
                                    src='images/date.gif'
                                    title='Click Here' alt='Click Here'
...
<%-- 					<td><textarea  name="taDesc" style="width: 195px; height : 50px;" maxlength="250"><%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((OfferModel)request.getAttribute(Constant.FORM_DATA)).getDesc() : ""%></textarea></td> --%>
<!-- 				</tr> -->
				<tr>
					<td colspan="2">
				...
				<tr>
					<td colspan="2" align="center"><input type="button" onclick="fnSaveOffer();"  tabindex="8"
						value="Save"> <input type="reset" value="Reset"  tabindex="9" onclick="javascript: document.frmAddOffer.sItem.focus(); resetEqItem();"></td>
				</tr>
			</table>
		</fieldset>
