...
<form method="post" name="frmAddCustomer">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Order Followup</legend>
			...
			<table cellpadding="3" border=1 style="width: 950px;" align="center" cellspacing="0">
				...
				<tr>
					...
					<td align="right">Remarks</td><td colspan="3"><b><%=((OrderModel)request.getAttribute(Constant.FORM_DATA)).getRemarks() %></b></td>
				</tr>
			</table>
	...
	<input type="hidden" name="chkBill" value="<%=((OrderModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+"O"+Utils.padBillNo(((OrderModel)request.getAttribute(Constant.FORM_DATA)).getOrderId())%>"/>
</form>
