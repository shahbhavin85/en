		...
		<fieldset>
			...
			<table cellpadding="3" border=1 style="width: 950px;" align="center" cellspacing="0">
				...
				<tr>
					...
					<td><b><%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getCtns()%></b></td>
					<td align="right">Packed By</td>
					<td><b><%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getPackedBy().getUserName()%></b></td>
					<td align="right" valign="top">Despatched By</td>
					<td valign="top"><b><%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getDespatchedBy().getUserName()%></b></td>
				</tr>
				<tr>
			...
			<table width="100%">
				<tr>
					<td align="center"><input type="button" value="Print All" onclick="printSalesBill('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>',0)" />
					&nbsp;<input type="button" value="Original Copy" onclick="printSalesBill('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>',1)" />
					&nbsp;<input type="button" value="Transport Copy" onclick="printSalesBill('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>',2)" />
					&nbsp;<input type="button" value="Office Copy" onclick="printSalesBill('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>',3)" />
					&nbsp;<input type="button" value="Delivery Challan" onclick="printDC('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>')" />
					&nbsp;<input type="button" value="Email" onclick="emailSales('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>')" />
					&nbsp;<input type="button" value="SMS" onclick="smsSales('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>')" />
					&nbsp;<input type="button" value="SMS LR Details" <%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getLrno().equals("") ? "disabled=\"disabled\"" : "" %> onclick="smsSalesLR('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>')" />
					&nbsp;<input type="button" value="Check List" onclick="checkList('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>')" />
					&nbsp;<input type="button" value="Edit Bill" <%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).isLock() ? "disabled=\"disabled\"" : "" %> onclick="editSalesBill('<%=((SalesModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+((SalesModel)request.getAttribute(Constant.FORM_DATA)).getSaleid()%>')" /></td> 
				</tr>
			</table>
		</fieldset>
