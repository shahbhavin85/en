		...
		<fieldset>
			...
			<table style="margin-top : 10px; margin-left : 20px; width: 950px;" cellspacing="3" cellpadding="0">
				<tr>
					...
					<td valign="top" style="padding-top: 3px;"><textarea  name="txtRemarks" style="width: 550px; height : 50px;" maxlength="120"></textarea></td>
			...
			<table width="80%">
				<tr>
					<td align="center"><input type="button" name="genBill" value="Generate Return Memo" onclick="fnGenerateBill();" /></td> 
				</tr>
			</table>
		</fieldset>
