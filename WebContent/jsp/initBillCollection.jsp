...
<form method="post" name="frmViewEnquiry">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Bill Collection</legend>
...
<!-- 						</select></td> -->
				...
				<%
					...
					SalesModel[] pendingBills = (request.getAttribute(Constant.PENDING_BILLS_LIST)!=null) ? (SalesModel[])request.getAttribute(Constant.PENDING_BILLS_LIST) : new SalesModel[0];
				...
				<tr>
					...
					<td colspan="1">
				<%
					if(((String)request.getAttribute("sType")).equals("41")){
				%>
						<input type="radio" onchange="fnPayChange(this);" value="41" name="sType" id="rPaymode1" checked="checked"/><label for="rPaymode1">Cash</label>
				<%
					} else if(((String)request.getAttribute("sType")).equals("42")){
				%>
						<input type="radio" onchange="fnPayChange(this);" value="42" checked="checked" name="sType" id="rPaymode2" /><label for="rPaymode2">CC Card</label>
				<%
					} else if(((String)request.getAttribute("sType")).equals("44")){
				%>
						<input type="radio" onchange="fnPayChange(this);" value="44" checked="checked" name="sType" id="rPaymode4" /><label for="rPaymode4">Customer Direct Bank Deposit (Cash / Fund Transfer)</label>
				<%
					} else {
				%>
						<input type="radio" onchange="fnPayChange(this);" value="43" checked="checked" name="sType" id="rPaymode3" /><label for="rPaymode3">Cheque</label>
				<%
					}
				%>
					</td>
				...
				<%
					if(((String)request.getAttribute("sType")).equals("43")){
				%>
				<tr>
				...
				<tr>
					<td colspan="4" align="center"><input type="button" name="btnSave" disabled="disabled" value="Save" onclick="fnSave();"/> <input type="button" name="btnBack" value="Back" onclick="fnBack();"/> </td>
				</tr>
				<%
					}
				%>
