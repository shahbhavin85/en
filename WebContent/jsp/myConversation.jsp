...
<form method="post" name="frmAddAccessPoint">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">INBOX</legend>
			<jsp:include page="messages.jsp"></jsp:include>
			<table style="min-width: 850px;">
				<tr>
					<td align="center"><input type="button" value="COMPOSE NEW CONVERSATION" onclick="fnGoToPage('MESSENGER_HANDLER','');"/>&nbsp;&nbsp;<input type="button" value="CLOSED CONVERSATION" onclick="fnGoToPage('MESSENGER_HANDLER','MY_CLOSED_CONVERSATION');"/></td>
				</tr>
			</table>
