...
<form method="post" name="frmAddCustomer">
	<div class="loginClass" style="min-width: 625px;">
		<fieldset>
			<legend class="screenHeader">Collection Follow up Details</legend>
			...
			<table border="1" cellspacing="0" id="enqItem" align="center" style="width: 600px;margin-top: 10px; font-size: 11px;">
				...
				<%
					SalesModel[] entries = (request.getAttribute(Constant.FORM_DATA) != null) ? ((SalesModel[])(request.getAttribute(Constant.FORM_DATA))) : new SalesModel[0];
