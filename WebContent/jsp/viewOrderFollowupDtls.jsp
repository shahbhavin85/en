...
<form method="post" name="frmAddCustomer">
	<div class="loginClass" style="min-width: 625px;">
		<fieldset>
			<legend class="screenHeader">Order Follow up Details</legend>
			...
			<table border="1" cellspacing="0" id="enqItem" align="center" style="width: 600px;margin-top: 10px; font-size: 11px;">
				...
				<%
					OrderModel[] entries = (request.getAttribute(Constant.FORM_DATA) != null) ? ((OrderModel[])(request.getAttribute(Constant.FORM_DATA))) : new OrderModel[0];
