...
<form method="post" name="frmAddUser">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Add New User</legend>
				...
				<fieldset>
					...
					<table cellpadding="3">
						...
						<tr>
							...
							<td><input type="text" maxlength="25" name="txtUserId" value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((UserModel)request.getAttribute(Constant.FORM_DATA)).getUserId() : ""%>"></td>	
							<td align="right">Password <span style="color: red">*</span> : </td>
							<td><input type="password" maxlength="25" name="txtPassword" value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((UserModel)request.getAttribute(Constant.FORM_DATA)).getPassword() : ""%>"></td>
						</tr>
						<tr>
...
<!-- 						<tr> -->
				...
				<table width="100%">
					<tr>
						<td colspan="2" align="center"><input type="button" onclick="fnSaveUser();"
							value="Save"> <input type="reset" value="Reset" onclick="javascript: document.frmAddUser.txtFullName.focus();"></td>
					</tr>
				</table>
		</fieldset>
