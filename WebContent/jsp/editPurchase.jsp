		...
		<fieldset>
			...
			<table cellpadding="0">
				<tr>
					...
					<td colspan="5"><input name="txtInvoiceNo" readonly="readonly" style="width: 195px;" value="<%=((PurchaseModel)request.getAttribute(Constant.FORM_DATA)).getBranch().getBillPrefix()+"P"+Utils.padBillNo(((PurchaseModel)request.getAttribute(Constant.FORM_DATA)).getPurchaseId())%>"></td>
				</tr>
				<tr>
			...
			<table style="margin-top : 10px; margin-left : 20px; width: 950px;" cellspacing="3" cellpadding="0">
				<tr>
					...
					<td rowspan="5" valign="top" style="padding-top: 3px;"><textarea  name="txtRemarks" style="width: 195px; height : 50px;" maxlength="120"><%=((request.getAttribute(Constant.FORM_DATA)) != null) ? ((PurchaseModel)request.getAttribute(Constant.FORM_DATA)).getRemark() : ""%></textarea></td>
					<td align="right">Extra (+) :</td>
					<td  style="width: 120px;"><input type="text" style="width: 110px; text-align: right;" name="txtExtra" value = "<%=((request.getAttribute(Constant.FORM_DATA)) != null) ? ((PurchaseModel)request.getAttribute(Constant.FORM_DATA)).getExtra() : "0"%>" onblur="fnChangeTotal(this);" onkeypress="return numbersonly(this, event, true);"></td>
				</tr>
				<tr>
					<td align="right">Discount (-) :</td>
					<td style="width: 120px;"><input type="text" style="width: 110px; text-align: right;" name="txtDiscount" value = "<%=((request.getAttribute(Constant.FORM_DATA)) != null) ? ((PurchaseModel)request.getAttribute(Constant.FORM_DATA)).getDiscount() : "0"%>" onblur="fnChangeTotal(this);" onkeypress="return numbersonly(this, event, true)"></td>
				</tr>
				<tr>
