...
<form method="post" name="frmAddCustomer">
	<div class="formClass">
		<fieldset>
			<legend class="screenHeader">Sales Invoice</legend>
...
<!-- 						</select> -->
			...
			<table style="width: 950px;">
				<tr>
					<td><input type="button" value="OFFER LIST" style="width: 120px;" onclick="fnGetOffers();"/></td>
				</tr>
				<tr><td style="padding-left: 5px;" colspan="4"> Item Name: <br/>
					...
					<td style="padding-left: 2px;">Rate : <br/><input readonly="readonly" type="text" name="txtRate" style="width: 75px;" value=""/></td>
			...
			<table style="margin-top : 10px; margin-left : 10px; width: 950px;" cellspacing="3" cellpadding="0">
				<tr>
					...
					<td  style="width: 120px;"><input type="text" style="width: 110px; text-align: right;" name="txtInstall" value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((SalesModel)request.getAttribute(Constant.FORM_DATA)).getInstallation() : "" %>" onblur="fnChangeTotal(this);" onkeypress="return numbersonly(this, event, true);"></td>
				</tr>
				<tr>
					<td align="right">Packing Charges (+) :</td>
					<td style="width: 120px;"><input type="text" style="width: 110px; text-align: right;" name="txtPacking" value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((SalesModel)request.getAttribute(Constant.FORM_DATA)).getPacking() : "" %>" onblur="fnChangeTotal(this);" onkeypress="return numbersonly(this, event, true)"></td>
				</tr>
				<tr>
					<td align="right">Forwarding Charges (+) :</td>
					<td style="width: 120px;"><input type="text" style="width: 110px; text-align: right;" name="txtForwarding" value="<%=(request.getAttribute(Constant.FORM_DATA) != null) ? ((SalesModel)request.getAttribute(Constant.FORM_DATA)).getForwarding() : "" %>" onblur="fnChangeTotal(this);" onkeypress="return numbersonly(this, event, true)"></td>
				</tr>
				<tr>
