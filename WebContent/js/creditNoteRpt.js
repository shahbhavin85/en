...
function fnGetMasterRpt(){
	document.forms[0].HANDLERS.value = "CREDIT_NOTE_REPORT_HANDLER";
	document.forms[0].ACTIONS.value = "GET_MASTER_RPT";
	fnFinalSubmit();
}

function fnShowSales(billNo){
	window.open('/en/app?HANDLERS=CREDIT_NOTE_HANDLER&ACTIONS=VIEW_CREDIT_NOTE&txtInvoiceNo='+billNo,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));
}
...
function fnPrintMasterRpt(){
	...
	window.open('/en/app?HANDLERS=CREDIT_NOTE_REPORT_HANDLER&ACTIONS=PRNT_MASTER_RPT'+params,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));
}
...
function fnExporMasterRpt(){
	...
	params = params+"&txtFromDate="+document.forms[0].txtFromDate.value;
	params = params+"&txtToDate="+document.forms[0].txtToDate.value;
	window.open('/en/app?HANDLERS=CREDIT_NOTE_REPORT_HANDLER&ACTIONS=EXPT_MASTER_RPT'+params,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));*/
}
