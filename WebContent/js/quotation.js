...
function fnExhibitionGenerateBill(){
	document.forms[0].genBill.disabled = true;
	if(isClick){
		isClick = false;
	} else {
...
function fnFinalExhibitionGenerateBill(){
	if(isClick && document.forms[0].genBill.disabled == true){
		...
		buildSalesItemData();
		document.forms[0].HANDLERS.value = "EXHIBITION_QUOTATION_HANDLER";
		document.forms[0].ACTIONS.value = "ADD_QUOTATION";
		fnFinalSubmit();
	}
}
...
function printQuotation(billNo, copyType){
	window.open('/en/app?HANDLERS=QUOTATION_HANDLER&ACTIONS=PRNT_QUOTATION&billNo='+billNo+'&copies='+copyType,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));
}

function editSalesBill(billNo){
	document.forms[0].txtInvoiceNo.value = billNo;
	document.forms[0].HANDLERS.value = "QUOTATION_HANDLER";
	document.forms[0].ACTIONS.value = "INIT_EDIT_QUOTATION";
	fnFinalSubmit();
}
...
function fnEditGenerateBill(){
	...
	buildSalesItemData();
	document.forms[0].HANDLERS.value = "QUOTATION_HANDLER";
	document.forms[0].ACTIONS.value = "EDIT_QUOTATION";
	fnFinalSubmit();
}
...
function fnEmailQuotation(qId){
	if(document.forms[0].email){
		document.forms[0].email.value = "Y";
	}
	document.forms[0].txtInvoiceNo.value = qId;
	document.forms[0].HANDLERS.value = "QUOTATION_HANDLER";
	document.forms[0].ACTIONS.value = "EMAIL_QUOTATION";
	fnFinalSubmit();
}

function smsQuotation(billNo){
...
function fnSalesmanGenerateBill(){
	document.forms[0].genBill.disabled = true;
	if(isClick){
		isClick = false;
	} else {
...
function fnFinalSalesmanGenerateBill(){
	if(isClick && document.forms[0].genBill.disabled == true){
		...
		buildSalesItemData();
		document.forms[0].HANDLERS.value = "SALESMAN_QUOTATION_HANDLER";
		document.forms[0].ACTIONS.value = "ADD_QUOTATION";
		fnFinalSubmit();
	}
