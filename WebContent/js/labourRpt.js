...
function fnGetMasterRpt(){
	document.forms[0].HANDLERS.value = "LABOUR_BILL_REPORT_HANDLER";
...
function fnPrintMasterRpt(){
	...
	window.open('/en/app?HANDLERS=LABOUR_BILL_REPORT_HANDLER&ACTIONS=PRNT_MASTER_RPT'+params,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));
}
...
function fnExporMasterRpt(){
	...
	params = params+"&txtFromDate="+document.forms[0].txtFromDate.value;
	params = params+"&txtToDate="+document.forms[0].txtToDate.value;
	window.open('/en/app?HANDLERS=LABOUR_BILL_REPORT_HANDLER&ACTIONS=EXPT_MASTER_RPT'+params,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));*/
}
