...
function fnFinalGenerateBill(){
	if(isClick && document.forms[0].genBill.disabled == true){
		...
		document.forms[0].ACTIONS.value = "ADD_ORDER_SALES";
		fnFinalSubmit();
	}
}
...
function buildSalesItemData(){
	...
	for(var i=1; i<rowsInTable; i++){
		var vTR = vItemTable.getElementsByTagName("tr")[i];
		if(document.getElementById("txtQty"+(i-1)).value != 0){
			itemdata = itemdata + vTR.getElementsByTagName("td")[0].innerHTML + "|" + vTR.getElementsByTagName("td")[1].innerHTML + "|" + vTR.getElementsByTagName("td")[2].innerHTML + "|" + document.getElementById("txtQty"+(i-1)).value + "|" + vTR.getElementsByTagName("td")[6].innerHTML + "|" + vTR.getElementsByTagName("td")[7].innerHTML + "#";
		}
	}
...
//	alert(document.getElementById("txtQty"+idx).value);
//	alert(vTR.getElementsByTagName("td")[4].innerHTML);
	vTR.getElementsByTagName("td")[9].innerHTML = document.getElementById("txtQty"+idx).value*vTR.getElementsByTagName("td")[6].innerHTML;
	fnRefreshTotal();
}