...
function fnGetMasterRpt(){
	document.forms[0].HANDLERS.value = "PURCHASE_REPORT_HANDLER";
...
function fnPrintMasterRpt(){
	...
	window.open('/en/app?HANDLERS=PURCHASE_REPORT_HANDLER&ACTIONS=PRNT_MASTER_RPT'+params,"","status=1,scrollbars=1, top=0, left=0,width="+(screen.width-10)+",height="+(screen.height-120));
}
